...
Проект можно посмотреть в репозитории — [вот здесь](https://github.com/curiuwu/Machine-Learning-projects/blob/main/heart_disease_prediction/heart_desease_prediction.ipynb).
