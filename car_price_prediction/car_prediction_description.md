...
Проект можно посмотреть в репозитории — [вот здесь](https://github.com/curiuwu/Machine-Learning-projects/blob/main/car_price_prediction/car_prediction.ipynb).
